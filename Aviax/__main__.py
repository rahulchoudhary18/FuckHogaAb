...
import sys
import traceback
import Aviax.modules.sql.users_sql as sql
...
from Aviax.modules import ALL_MODULES
from Aviax.modules.helper_funcs.chat_status import is_user_admin
from Aviax.modules.helper_funcs.alternate import typing_action
from Aviax.modules.helper_funcs.misc import paginate_modules
from Aviax.modules.disable import DisableAbleCommandHandler
...
async def awake(event):
  ...
  AVIAX_BUTTON = [
      [
          Button.url("🚑 Support", f"https://t.me/AviaxSupport"),
          Button.url("📢 Updates", "https://t.me/AviaxOfficial")
      ]
  ]
...
PM_START_TEXT = """
────「 [{}](https://telegra.ph/file/d05a3ce6f08404cd88361.jpg) 」────
*Hola! {},*
*I am a next generation advance group management bot with a lot of Features.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
• *Uptime:* `{}`
• `{}` *users, across* `{}` *chats.*
➖➖➖➖➖➖➖➖➖➖➖➖➖
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Aviax.modules." + module_name)
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="🚑 Support",
                            url=f"https://telegram.dog/AviaxSupport",
                        ),
                        InlineKeyboardButton(
                            text="📢 Updates",
                            url="https://telegram.dog/AviaxOfficial",
                        ),
                    ]
                ]
            ),
