...
from Aviax import telethn as tbot, ubot2
...
async def logo_gen(event):
    ...
    if event.reply_to_msg_id:
        ...
        fpath_ = glob.glob("./Aviax/utils/Logo/*")
    ...
    if os.path.exists(flnme):
        await tbot.send_file(
            event.chat_id,
            file=flnme,
            caption="Logo by [Aνιαχ вєαтz](https://t.me/AviaxBeatzBot)",
    ...
    if os.path.exists(font_):
        if not font_.startswith("./Aviax/utils/Logo"):
            os.remove(font_)
